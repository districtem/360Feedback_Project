...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'feedback_feedback', 'recipient',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.BaseEmployee'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'feedback.feedback': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feedback.BaseEmployee']", 'null': 'True'})
        }
    }
