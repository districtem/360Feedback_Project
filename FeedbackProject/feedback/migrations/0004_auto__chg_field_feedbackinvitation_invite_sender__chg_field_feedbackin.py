...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedbackInvitation.invite_sender'
        db.alter_column(u'feedback_feedbackinvitation', 'invite_sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.FeedbackRecipient']))

        # Changing field 'FeedbackInvitation.invite_receiver'
        db.alter_column(u'feedback_feedbackinvitation', 'invite_receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.Employee']))

    def backwards(self, orm):

        # Changing field 'FeedbackInvitation.invite_sender'
        db.alter_column(u'feedback_feedbackinvitation', 'invite_sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.Employee']))

        # Changing field 'FeedbackInvitation.invite_receiver'
        db.alter_column(u'feedback_feedbackinvitation', 'invite_receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.FeedbackGiver']))
